      ...
      <div className='bg-[#90aead] font-sans min-h-screen pb-8 '>
        ...
        <div className='grid justify-items-center'>
          {data.map((element) => {
            return (
              <div
                className='block my-10 relative w-[350px] lg:w-[800px] h-72 bg-cover bg-red-300 overflow-hidden group rounded-md shadow-xl'
                style={{ backgroundImage: `url(${element.img})` }}
                key={element.id}
              >
                <div
                  className={`absolute h-60 w-full bottom-0 translate-y-52 group-hover:translate-y-1 transition-transform ease duration-700 pb-2`}
                >
